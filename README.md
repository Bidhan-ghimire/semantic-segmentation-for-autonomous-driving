...
- If you encounter import or version issues on your machine, try `image-classifiers==1.0.0b1` instead (update `requirements.txt` accordingly).

## Datasets

Datasets are **not** included in this repository. You must download them separately and configure dataset paths in the notebooks.
